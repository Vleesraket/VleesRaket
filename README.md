...
### Claw of Duty
Story-driven 2D top-down action game built in Godot 4. Play as Patches, a street-smart Cypriot cat fighting through four acts of an infected city to deliver an antidote — powered by a data-driven dialogue and quest system.
...
### [Quinn Web Services](https://quinnotto.nl)
Freelance web development. Full-stack sites, dashboards, and custom tooling — built to last.

`Next.js` `PostgreSQL` `GSAP` `Cloudflare`
...
| **Stage Finder** | CLI + web panel that scrapes internship listings and ranks by travel distance | Node.js · Express |
| **GLR Expositie** | Platform for photographers to share and sell their work | Next.js · Firebase · Stripe |
| **BEKBV Website** | Corporate site for a Dutch installation company | Next.js · TypeScript · Tailwind |
| **Trivify** | Discord quiz bot with categories, score tracking, leaderboard | Discord.js · Firebase |
| **Bottle Counter** | School canteen loyalty points webapp | Python · Next.js · MongoDB |

→ [All projects on GitHub](https://github.com/vleesraket) · [Full portfolio](https://portfolio.quinnotto.nl)
